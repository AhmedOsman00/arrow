...
final class MoreViewModel: MoreViewModelProtocol {
    ...
    init(mainManager: MoreManagerProtocol,
    ...
    func getFactoryInfo() -> String {
        analytics.logEvent("factory_info_requested", parameters: [
    ...
    func fetchLocalData() async throws -> String {
        ...
        do {
            ...
            analytics.logEvent("fetch_local_data_success", parameters: [
                "data_length": data.count
            ])
            return data
        } catch {
            analytics.logEvent("fetch_local_data_failed", parameters: [
    ...
    func fetchRemoteData() async throws -> String {
        ...
        do {
            ...
            analytics.logEvent("fetch_remote_data_success", parameters: [
                "data_length": data.count
            ])
            return data
        } catch {
            analytics.logEvent("fetch_remote_data_failed", parameters: [
                "error": error.localizedDescription
            ])
            throw error
        }
